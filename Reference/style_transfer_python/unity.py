...
def get_image():
    ...
    # 原图
    img = plt.imread('D:\\Project\\Unity_siki\\AIProject\\Assets\\Image\\Before\\Image.jpg')
    img = img/255.

    # 风格图
    style = plt.imread('D:\\Project\\Unity_siki\\AIProject\\Assets\\Image\\Style\\Style.jpg')
    style = style/255.
